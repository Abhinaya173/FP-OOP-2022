 ...
 * @author ABHINAYA
 */
public class Reggister extends javax.swing.JFrame {

    /**
     * Creates new form Reggister
     */
    public Reggister() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reggister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
